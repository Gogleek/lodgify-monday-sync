...
SOURCE_LABELS = {
    # map common channels to your dropdown labels; extend as needed
    "manual": "Manual",
    "booking.com": "Booking.com",
    "airbnb": "Airbnb",
    "direct": "Direct",
}
# If not matched, we’ll fall back to source_text in long_text.
...
def map_booking_to_monday(bk: dict) -> dict:
    ...
    if source_label:
        ...
        # if we can't map, მაინც შევინახოთ სრული ტექსტი long_text-ში
